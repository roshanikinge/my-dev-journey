...
# # globle and local varible same define kelela nasel tr global variable ha function madhe used kelya jato 
# #जेव्हा एकच value अनेक functions मध्ये share/modify करायची असते तेव्हा global वापरतो
